                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{route('sliders.update',$editdata->id)}}" id="myForm" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$editdata->main_title}}" name="main_title" class="form-control" id="main_title">
                                            <small style="color:red"> {{($errors->has('main_title'))?($errors->first('main_title')):''}}</small>
                                        </div>

                                        <div class="form-group">
                                            <label> Description </label>
                                            <input type="text"  value="{{$editdata->description}}" name="description" class="form-control" id="description">
                                            <small style="color:red"> {{($errors->has('description'))?($errors->first('description')):''}}</small>
                                        </div>

                                        <div class="form-group">
                                            <label> Button Title </label>
                                            <input type="text" name="btn_title" value="{{$editdata->btn_title}}"  class="form-control" id="btn_title">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$editdata->btn_link}}" name="btn_link" class="form-control" id="btn_link">
