                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    ...
                                    <a class="btn btn-success float-right" href="{{route('size.view')}}"> View Size</a>
                                </h3>

                                <div class="card-body">

                                    <form method="post" action="{{(@$editdata)?route('size.update',$editdata->id):route('size.store')}}" id="myForm">
                                        {{csrf_field()}}
