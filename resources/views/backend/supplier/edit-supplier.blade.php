                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{route('suppliers.update',$editData->id)}}" id="myForm">
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile_no" class="form-control" id="mobile_no" value="{{$editData->mobile_no}}" placeholder="Enter supplier mobile">  <br/>
                                            <label> Supplier Email </label>
                                            <input type="email" name="email" class="form-control" id="email" value="{{$editData->email}}" placeholder="Enter supplier email"> <br/>
