                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{route('habout_us.update',$editdata->id)}}" id="myForm">
                                        {{csrf_field()}}  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="left_title" value="{{$editdata->left_title}}" class="form-control"  placeholder="Enter left title">
                                            <small style="color:red"> {{($errors->has('left_title'))?($errors->first('left_title')):''}}</small>
                                        </div> 

                                        <div class="form-group">
                                            <label>Left Subtitle</label>
                                            <input type="text" name="left_subtitle" value="{{$editdata->left_subtitle}}"  class="form-control" id="left_subtitle">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="right_desc" class="form-control" id="right_desc">
                                               {{$editdata->right_desc}}
                                            </textarea>
