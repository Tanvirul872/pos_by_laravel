            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                ...
                <div id="hero">
                    ...
                    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                        ...
                        <div class="item" style="background-image: url( {{ 'upload/user_images/'.$slider->image }});">
                            <div class="container-fluid">
                                <div class="caption bg-color vertical-center text-left">
                                    <div class="slider-header fadeInDown-1"> {{$slider->title}}  </div>
                                    <div class="big-text fadeInDown-1"> {{$slider->main_title}} </div>
                                    <div class="excerpt fadeInDown-2 hidden-xs"> <span>   {{$slider->description}} </span> </div>
                                    <div class="button-holder fadeInDown-3"> <a href="{{$slider->btn_link}}" class="btn-lg btn btn-uppercase btn-primary shop-now-button"> {{$slider->btn_title}} </a> </div>
                                </div>
                                <!-- /.caption -->
                            </div>
                            <!-- /.container-fluid -->
                ...
                <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                    <div class="more-info-tab clearfix ">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            <li><a data-transition-type="backSlide" href="#category{{$category->category_id}}" data-toggle="tab">  {{$category['category']['name']}} </a></li>
                            @endforeach
                        </ul>
                        <!-- /.nav-tabs -->
                    </div>
                                ...
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="{{route('products.details.info',$product->slug)}}"><img  src="{{url('upload/product_images/'.$product->image)}}" alt=""></a> </div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="{{route('products.details.info',$product->slug)}}"> {{$product->name}} </a></h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                                    <div class="product-price"> <span class="price"> {{$product->price}}tk </span>  </div>
                                                    <!-- /.product-price -->
                        ...
                        <div class="tab-pane" id="category{{$category->category_id}}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    ...
                                    @php
                                       $catwiseProduct = App\Model\Product::where('category_id',$category->category_id)->orderBy('category_id','DESC')->get();
                                    @endphp
                                    @foreach($catwiseProduct as $catpro)

                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="detail.html"><img  src="{{url('upload/product_images/'.$catpro->image)}}" alt=""></a> </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="detail.html"> {{$catpro->name}} </a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="description"></div>
                                                        <div class="product-price"> <span class="price"> {{$catpro->price}}tk </span>  </div>
                                                        <!-- /.product-price -->
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @php
                            ...
                            $catName = App\Model\Category::where('id','6')->first();
                        @endphp
                        {{$catName->name}}
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        @php
                            $cat = $hcategory['0']->category_one ;
                            $catwiseProduct = App\Model\Product::where('category_id',$cat)->get();
                        @endphp
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        <h3 class="section-title">
                            @php
                                $catName = App\Model\Category::where('id','7')->first();
                            @endphp
                            {{$catName->name}}
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @php
                            $catName = App\Model\Category::where('id','8')->first();
                        @endphp
                        {{$catName->name}}
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        ...
                        @php
                            $cat = $hcategory['0']->category_three ;
                            $catwiseProduct = App\Model\Product::where('category_id',$cat)->get();
                        @endphp
                        @foreach($catwiseProduct as $catpro)
