          ...
          <div class="top-bar animate-dropdown">
              <div class="container">
                  <div class="header-top-inner">
                      <div class="cnt-account">
                          <ul class="list-unstyled">
                               <li><a href="{{route('customer.login')}}"><i class="icon fa fa-lock"></i>Login</a></li>
                          </ul>
                      </div>
                      <!-- /.cnt-account -->
...
{{--                                  </li>--}}
                              ...
                              @foreach($menuglobal as $headmenu)

                                      <li class="dropdown"> <a href="{{$headmenu->link}}" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">{{$headmenu->name}} </a>
                                          @php
                                              $id=$headmenu->id;
                                                $subcat=App\Model\SubMenuItem::where('menu_item_id',$id)->get();
                                          @endphp
                                                  ...
                                                  <div class="yamm-content">
                                                      <div class="row">
                                                          <div class="col-xs-12 col-menu">
                                                              <ul class="links">
                                                                  @foreach($subcat as $headsubmenu)
                                                                      <li><a href="home.html">{{$headsubmenu->name}}</a></li>
                                                                  @endforeach
                                                              </ul>
                                                          </div>
                                                      </div>
